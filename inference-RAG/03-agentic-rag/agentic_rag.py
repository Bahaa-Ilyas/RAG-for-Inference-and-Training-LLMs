"""Pedagogical runnable demo for Agentic RAG / multi-step retrieval.
...
METHOD = {
    "name": 'Agentic RAG / multi-step retrieval',
    "key": 'agentic',
    "mode": 'inference',
    "script": 'agentic_rag.py',
    "description": 'Plan multiple retrieval/tool steps and synthesize evidence from the trace.',
