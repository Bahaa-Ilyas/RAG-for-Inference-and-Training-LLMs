"""Pedagogical runnable demo for RAPTOR / hierarchical retrieval.
...
METHOD = {
    ...
    "key": 'raptor',
    "mode": 'inference',
    "script": 'raptor_hierarchical_rag.py',
    "description": 'Retrieve section summaries first, then expand to leaf chunks.',
