"""Pedagogical runnable demo for Self-RAG / adaptive retrieval.
...
METHOD = {
    ...
    "key": 'self_rag',
    "mode": 'inference',
    "script": 'self_rag_adaptive.py',
    "description": 'Decide whether retrieval is needed, then retrieve or skip based on the query.',
