"""Run the method-specific cookbook demo for Self-RAG / adaptive retrieval.
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Run the cookbook demo for Self-RAG / adaptive retrieval')
