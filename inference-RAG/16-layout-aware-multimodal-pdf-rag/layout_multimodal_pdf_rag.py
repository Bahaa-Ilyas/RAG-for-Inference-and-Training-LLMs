"""Pedagogical runnable demo for Layout-aware / multimodal PDF RAG.
...
METHOD = {
    "name": 'Layout-aware / multimodal PDF RAG',
    "key": 'layout_pdf',
    "mode": 'inference',
    "script": 'layout_multimodal_pdf_rag.py',
    "description": 'Search layout-aware PDF elements with page, OCR, caption, and bounding-box metadata.',
