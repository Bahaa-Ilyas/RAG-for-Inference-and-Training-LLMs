"""Pedagogical runnable demo for Metadata-filtered RAG / auto-retrieval.
...
METHOD = {
    "name": 'Metadata-filtered RAG / auto-retrieval',
    "key": 'metadata_filtered',
    "mode": 'inference',
    "script": 'metadata_filtered_rag.py',
    "description": 'Infer simple filters from the query and apply them before retrieval.',
