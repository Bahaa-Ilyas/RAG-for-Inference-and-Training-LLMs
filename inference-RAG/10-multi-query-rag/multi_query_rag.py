"""Pedagogical runnable demo for Multi-query RAG.
...
METHOD = {
    ...
    "key": 'multi_query',
    "mode": 'inference',
    "script": 'multi_query_rag.py',
    "description": 'Run several query variants in parallel and deduplicate/rerank results.',
