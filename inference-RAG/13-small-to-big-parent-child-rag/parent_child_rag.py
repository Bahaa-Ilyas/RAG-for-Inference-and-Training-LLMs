"""Pedagogical runnable demo for Small-to-big retrieval / parent-child retrieval.
...
METHOD = {
    "name": 'Small-to-big retrieval / parent-child retrieval',
    "key": 'parent_child',
    "mode": 'inference',
    "script": 'parent_child_rag.py',
    "description": 'Retrieve precise child chunks and expand them to parent sections.',
