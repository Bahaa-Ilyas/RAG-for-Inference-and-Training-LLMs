"""Pedagogical runnable demo for Webpage RAG with crawler and freshness control.
...
METHOD = {
    "name": 'Webpage RAG with crawler and freshness control',
    "key": 'webpage_freshness',
    "mode": 'inference',
    "script": 'webpage_freshness_rag.py',
    "description": 'Deduplicate pages and prefer the newest canonical crawled content.',
