"""Pedagogical runnable demo for Table-aware RAG.
...
METHOD = {
    "name": 'Table-aware RAG',
    "key": 'table_aware',
    "mode": 'inference',
    "script": 'table_aware_rag.py',
    "description": 'Retrieve structured table records and execute a toy aggregation.',
