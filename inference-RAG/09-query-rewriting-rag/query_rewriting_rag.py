"""Pedagogical runnable demo for Query rewriting / query expansion RAG.
...
METHOD = {
    "name": 'Query rewriting / query expansion RAG',
    "key": 'query_rewriting',
    "mode": 'inference',
    "script": 'query_rewriting_rag.py',
    "description": 'Generate retrieval rewrites and fuse candidates from each rewrite.',
