"""Pedagogical runnable demo for Reranked RAG.
...
METHOD = {
    ...
    "key": 'reranked',
    "mode": 'inference',
    "script": 'reranked_rag.py',
    "description": 'Retrieve broadly, then rerank candidate passages with a cross-encoder-style scorer.',
