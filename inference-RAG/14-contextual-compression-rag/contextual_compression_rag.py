"""Pedagogical runnable demo for Contextual compression RAG.
...
METHOD = {
    ...
    "key": 'contextual_compression',
    "mode": 'inference',
    "script": 'contextual_compression_rag.py',
    "description": 'Retrieve chunks and compress them to query-relevant sentences.',
