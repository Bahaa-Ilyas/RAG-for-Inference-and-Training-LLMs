"""Run the method-specific cookbook demo for Tool-augmented RAG / API RAG.
...
METHOD_KEY = '19-tool-augmented-rag'


def main() -> None:
    parser = argparse.ArgumentParser(description='Run the cookbook demo for Tool-augmented RAG / API RAG')
