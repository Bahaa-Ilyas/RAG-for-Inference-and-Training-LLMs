"""Pedagogical runnable demo for Corrective RAG / CRAG.
...
METHOD = {
    ...
    "key": 'crag',
    "mode": 'inference',
    "script": 'corrective_rag_crag.py',
    "description": 'Grade initial retrieval quality and correct with a rewritten query when needed.',
