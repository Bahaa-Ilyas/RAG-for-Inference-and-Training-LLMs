"""Pedagogical runnable demo for Version-aware RAG.
...
METHOD = {
    "name": 'Version-aware RAG',
    "key": 'version_aware',
    "mode": 'inference',
    "script": 'version_aware_rag.py',
    "description": 'Apply version and current/superseded filters before retrieval.',
