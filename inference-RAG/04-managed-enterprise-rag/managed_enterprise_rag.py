"""Pedagogical runnable demo for Managed enterprise RAG platforms.
...
METHOD = {
    "name": 'Managed enterprise RAG platforms',
    "key": 'managed_enterprise',
    "mode": 'inference',
    "script": 'managed_enterprise_rag.py',
    "description": 'Simulate managed enterprise retrieval with ACL trimming before search.',
