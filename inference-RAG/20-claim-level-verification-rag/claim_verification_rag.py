"""Pedagogical runnable demo for Claim-level verification RAG.
...
METHOD = {
    "name": 'Claim-level verification RAG',
    "key": 'claim_verification',
    "mode": 'inference',
    "script": 'claim_verification_rag.py',
    "description": 'Draft atomic claims and verify support against retrieved evidence.',
