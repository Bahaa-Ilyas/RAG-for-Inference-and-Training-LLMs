"""Run the method-specific cookbook demo for Hybrid RAG: BM25 + dense vector retrieval.
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Run the cookbook demo for Hybrid RAG: BM25 + dense vector retrieval')
